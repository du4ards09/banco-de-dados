...
INSERT INTO tbProduto(nomeProduto,pre�oProduto,dataEntradaProduto,estoqueProduto,codFuncionario,codFabricante)
VALUES ('kimono feminino paisley em linho',199.00,12/03/2021,300,1,1)
	('cardigan xadrez em tric� branco',159.00,12/03/2021,400,1,1)
	...
	('Conjunto Blus�o e Cal�a Menino Cinza',66.47,20/08/2021,1,3)
SELECT*FROM tbProduto

INSERT INTO tbFuncionario(nomeFuncionario,dataAdmissao,salarioFuncionario)
VALUES ('Jubil�ia das Cruzes',20/09/2012,1200.00)
